...
DOWNLOAD_URL=https://d2p6pa21dvn84.cloudfront.net/api/plugins/confluentinc/kafka-connect-s3/versions/10.0.5/confluentinc-kafka-connect-s3-10.0.5.zip
...
# DOWNLOAD_URL=https://d2p6pa21dvn84.cloudfront.net/api/plugins/confluentinc/voluble/versions/0.3.1/confluentinc-voluble-0.3.1.zip
...
if [ ${WITH_AVRO} == "Y" ]; then
  ...
  DOWNLOAD_URL=https://d2p6pa21dvn84.cloudfront.net/api/plugins/confluentinc/kafka-connect-avro-converter/versions/6.0.3/confluentinc-kafka-connect-avro-converter-6.0.3.zip
